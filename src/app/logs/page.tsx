...
export default function LogsPage() {
  ...
  return (
    <>
      <h1 className="text-2xl font-bold mb-6 text-accent">Application Logs</h1>
      <div className="bg-white/10 rounded-xl p-6 shadow border border-white/10">
        <p className="text-gray-300">View, search, and filter logs for your applications here.</p>
      </div>
    </>
  );
} 
